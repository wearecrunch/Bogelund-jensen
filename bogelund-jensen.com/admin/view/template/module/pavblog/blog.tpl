...
//BOGDAN - START
 <tr>
												 <td><?php echo "Social Buttons";?></td>
												 <td>
													 <?php if (strlen($pavblog_blog_descriptions[1]['title'])>0){	$actual_link = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
													 		$url = "http://www.bogelund-jensen.com/image/";
													 		$actual_link1 = str_replace('/admin', '', $actual_link);
													 		$actual_link2 = str_replace('module/', '', $actual_link1);
													 		$actual_link3 = substr($actual_link2, 0, strpos($actual_link2,'&amp;token='));
													 		echo "<a href='https://www.facebook.com/sharer/sharer.php?u=" . urlencode($actual_link3) . "' target='_blank'><img src='http://bogelund-jensen.com/images/social/facebook_normal.png'></a>"."  ";
													 		echo "<a href='https://twitter.com/share?url=http://www.bogelund-jensen.com/index.php?route=pavblog/blog" . "%26"  ."id=" . $pavblog_blog_descriptions[1]['blog_id'] . "&amp;text=" . $pavblog_blog_descriptions[1]['title'] . " - ". "&via=TotalSBJ' target='_blank'><img src='http://bogelund-jensen.com/images/social/twitter_normal.png'></a>"."  ";
													 		echo "<a href='https://pinterest.com/pin/create/bookmarklet/?media=" . $url . $blog['image'] . "&url=http://www.bogelund-jensen.com/index.php?route=pavblog/blog" . "%26" ."id=" . $pavblog_blog_descriptions[1]['blog_id'] . "&description=" . $pavblog_blog_descriptions[1]['title'] . "' target='_blank'><img src='http://bogelund-jensen.com/images/social/pinterest_normal.png'></a>";
}
													  ?>
												 </td>
											 </tr>
