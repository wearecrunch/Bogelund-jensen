...
<?php if ($this->registry->get('config')->get('dragndrop_position_status') && ($this->registry->get('config')->get('dragndrop_position_access') && in_array($this->registry->get('user')->getId(), (array)$this->registry->get('config')->get('dragndrop_position_access')))) { ?><script type="text/javascript" src="view/javascript/DragNDropPosition/dragNdrop_position.js"></script><?php } ?>
</head>
<body>
<div id="container">
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
	  ...
	  <li id="help"><a class="top">Dansk sprogpakke 4.7.3</a>
        <ul>
          <li><a href="http://sllwi.re/p/20" target="_blank">Køb licens</a></li>
          <li><a href="http://medianyt.dk/files/handelsbetingelser_dksp.pdf" target="_blank">Licensreglement</a></li>
          <li><a href="mailto:dl@medianyt.dk" target="_blank">Support</a></li>
        </ul>
      </li>
    </ul>
