	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['categories'][] = array(
				...
				'name'        => $result['name'],
				'sort_order'  => (!$this->config->get('dragndrop_position_status')) ? $result['sort_order'] : $this->db->query("SELECT sort_order FROM " . DB_PREFIX . "category WHERE category_id = '" . (int)$result['category_id'] . "'")->row['sort_order'],
