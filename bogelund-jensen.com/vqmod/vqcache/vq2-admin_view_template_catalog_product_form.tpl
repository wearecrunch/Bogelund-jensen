...
<td><?php echo $entry_tax_class; ?></td>
        ...
        <div id="tab-attribute">
          <table id="attribute" class="list">
            <thead>
              <tr>
                <td width="1"> </td><td class="left"><?php echo $entry_attribute; ?></td>
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                <td style="text-align: center;"><img src="view/javascript/DragNDropPosition/image/<?php echo ($this->config->get('dragndrop_position_status')) ? 'ddp_drag_on.png' : 'ddp_drag_off.png'; ?>" alt="Drag" title="Drag" class="ddp_drag" /></td><td class="left"><input type="text" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" />
        ...
        <div id="tab-option">
          ...
          <div id="tab-option-<?php echo $option_row; ?>" class="vtabs-content">
            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              <thead>
                <tr>
                  <td width="1"> </td><td class="left"><?php echo $entry_option_value; ?></td>
...
<?php if ($this->registry->get('config')->get('dragndrop_position_status') && ($this->registry->get('config')->get('dragndrop_position_access') && in_array($this->registry->get('user')->getId(), (array)$this->registry->get('config')->get('dragndrop_position_access')))) { ?>
				$('#tab-attribute #attribute tbody').dragNdrop_position();
			<?php } ?>
	html  = '<tbody id="attribute-row' + attribute_row + '">';
    html += '  <tr>';
	html += '    <td style="text-align: center;"><img src="view/javascript/DragNDropPosition/image/<?php echo ($this->config->get('dragndrop_position_status')) ? 'ddp_drag_on.png' : 'ddp_drag_off.png'; ?>" alt="Drag" title="Drag" class="ddp_drag" /></td><td class="left"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" /></td>';
	html += '    <td class="left">';
	<?php foreach ($languages as $language) { ?>
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '  	 <thead>'; 
			html += '      <tr>';
			html += '        <td width="1"> </td><td class="left"><?php echo $entry_option_value; ?></td>';
...
<?php if ($this->config->get('dragndrop_position_status') && ($this->config->get('dragndrop_position_access') && in_array($this->user->getId(), (array)$this->config->get('dragndrop_position_access')))) { ?>
	...
	html += '  <tr>';
html += '<td style="text-align: center;"><img src="view/javascript/DragNDropPosition/image/<?php echo ($this->config->get('dragndrop_position_status')) ? 'ddp_drag_on.png' : 'ddp_drag_off.png'; ?>" alt="Drag" title="Drag" class="ddp_drag" /></td>';
...
<?php if ($this->config->get('dragndrop_position_status') && ($this->config->get('dragndrop_position_access') && in_array($this->user->getId(), (array)$this->config->get('dragndrop_position_access')))) { ?>
	...
	html += '  <tr>';
	html += '    <td style="text-align: center;"><img src="view/javascript/DragNDropPosition/image/<?php echo ($this->config->get('dragndrop_position_status')) ? 'ddp_drag_on.png' : 'ddp_drag_off.png'; ?>" alt="Drag" title="Drag" class="ddp_drag" /></td><td class="left"><div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
