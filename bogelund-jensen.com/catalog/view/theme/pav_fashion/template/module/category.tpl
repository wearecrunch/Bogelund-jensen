<div class="box category highlights">
	<div class="box-heading"><span><?php echo $heading_title; ?></span><span class="fa fa-angle-down pull-right"></span></div>
	<div class="box-content">
      ...
      $category['name'] = str_replace(")", ')</span>', $name); 
			...
			<li class="<?php echo $class; ?>">
				...
				<a class="subcart collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne<?php echo $k ;?>"></a>				
