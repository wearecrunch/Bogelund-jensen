...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="col-lg-6 col-md-6 image-container">
        ...
        <?php } ?>
        <?php if ($images) { ?>
        <div class="image-additional slide carousel fivetwofive hidden-xs" id="image-additional"><div id="image-additional-carousel" class="carousel-inner">
        <?php 
...
<?php echo $description; ?>
  ...
  <div class="product-extra">
          ...
          <input class="form-control" type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" />
            ...
            <div class="cart"><img src="catalog/view/theme/pav_fashion/image/default/bag.png" alt="Bag" height="17" width="20"><input type="button" value="<?php echo $button_cart; ?>" id="button-cart" class="" /></div>
 ...
 <!--START OF DESCRIPTION TABS - bogdan <div class="tabs-group">
  ...
  <?php } ?>
   ...
   <?php } ?> 
  </div> END OF DESCRIPTION TAB - bogdan-->
