<?php require( DIR_TEMPLATE.$this->config->get('config_template')."/template/common/config.tpl" ); 
	...
	$MAX_ITEM_ROW_SMALL = $categoryConfig['listing_products_columns_small'] ?$categoryConfig['listing_products_columns_small']:3;
    ...
    <div class=" col-xs-6 col-lg-<?php echo $span;?>  col-md-<?php echo $span;?>  col-sm-<?php echo $small;?> col-xs-<?php echo $mini;?>">
    	<div class="product-block">	
	      ...
	      <div class="image"><?php if( $product['special'] ) {   ?>
	    	...
	    	<a class="img" href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" /></a>
	      	...
	      	<a href="<?php echo $zimage;?>" class="colorbox product-zoom hidden" rel="nofollow" title="<?php echo $product['name']; ?>"><span class="fa fa-search-plus"></span></a>
	      	<?php } ?>
		...
		<div class="product-meta">
	      ...
	      <div class="product-action">
		      ...
		      <div class="cart">
		      	<img style="margin-top:-4px;" src="catalog/view/theme/pav_fashion/image/default/bag.png" alt="bag">
