	...
	<div class="footer-center">
		<div class="container"><div class="inner">
			...
			<div class="row">
				...
				<?php if( isset($themeConfig['contact_us_data']) )  { ?>
				<div class="column col-xs-12 col-sm-6 col-lg-3 col-md-3">
		...
		<div class="container"><div class="inner clearfix">
			<!--<div class="copyright">
				...
				<?php } else { ?>
					<?php echo $powered; ?>. 
				<?php } ?>-->
				Copyright Signe Bøgelund-Jensen. Site developed by <a href="http://wearecrunch.dk/" target="_blank" title="Crunch">Crunch</a>
			</div>
