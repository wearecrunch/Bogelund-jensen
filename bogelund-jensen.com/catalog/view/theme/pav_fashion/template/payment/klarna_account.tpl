  ...
  <div class="content">
    <table class="form">
      ...
      <tr>
        ...
        <td><select class="form-control" name="pno_day">
      ...
      <tr>
        ...
        <td><input class="form-control" type="text" name="pno" value="" /></td>
      </tr>
      <?php } ?>
      ...
      <tr>
        ...
        <td><input class="form-control" type="text" name="house_no" value="<?php echo $street_number; ?>" /></td>
      </tr>
      <?php } ?>
      <?php if ($iso_code_3 == 'NLD') { ?>
      <tr>
        <td><?php echo $entry_house_ext; ?></td>
        <td><input class="form-control" type="text" name="house_ext" value="<?php echo $street_extension; ?>" /></td>
      </tr>
      <?php } ?>
      <tr>
        <td><?php echo $entry_phone_no; ?></td>
        <td><input class="form-control" type="text" name="phone_no" value="<?php echo $phone_number; ?>" /></td>
      </tr>
